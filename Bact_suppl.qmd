...
## take this out? would need to modifcy the text below. 
...
model_df_complete <-
  ...
  mutate(
    ...
    NEU = as.numeric(NEU),
    PLT = as.numeric(PLT),
    t_WBC = as.numeric(t_WBC),
    t_CREA = as.numeric(t_CREA),
    WBC_noNEU = as.numeric(WBC_noNEU),
    t_WBC_noNEU = as.numeric(t_WBC_noNEU)
  )

model_df_complete %>% skimr::skim()
