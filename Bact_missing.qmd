# Results of ID: Missing data {#Missing}
...
b_bact %>%
  ...
  mutate(Predictors_of_medium_importance = ifelse(apply(b_bact[,c(medimp_predictors)],1,function(X) 1-any_miss(X)),NA,1)) %>%   
...
## @Mark: can you please make the table nicer? I can't get a proper structure with GENDER and AGEGROUP.
